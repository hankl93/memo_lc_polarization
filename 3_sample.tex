...
\begin{itemize}
    ...
    %The numbers of selected PHSP signal are at least 20 times larger than those of data at each energy point.
    %\item PWA signal MC samples, in which events of $\lcp \to pK^-\pi^+$ are generated following the results of PWA fit,
\end{itemize}
